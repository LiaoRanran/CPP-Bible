...
| Phase | 名称 | 子项数 | 优先级 |
|-------|------|--------|--------|
| A | 质量加固（交叉引用/CI豁免/术语） | 10 | P0 |
| B | 发布提升（实证扩展/CHANGELOG/PDF） | 8 | P1 |
| C | 体验优化（Mermaid/编号/代码块） | 6 | P2 |

**详细工作清单**：见 `WORKLIST_v4.md`（与本文互补）。

### §10.2 关键里程碑（待达成）

- [ ] **A1 交叉引用 0 断裂**：147 章全量引用链完整
- [ ] **A2 CI 豁免消化**：可修豁免降至 0，真实门禁覆盖 110+/147
- [ ] **B1 方向 1 实证 10+ 例**：非核心章选 2-4 例追加
- [ ] **B2 v1.1.0 发布**：CHANGELOG + tag + Release
- [ ] **B3 PDF 全量构建**：含 Mermaid 静态渲染
