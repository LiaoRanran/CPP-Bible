...
| 17 | `tests\test_cross_card_attack_624.py` |
| 18 | `tests\test_defense_chain_610.py` |
| 19 | `tests\test_defense_chain_cli_610.py` |
| 20 | `tests\test_learner_behavior_logger_614.py` |
| 21 | `tests\test_learner_twin_validation_615.py` |
| 22 | `tests\test_weighted_af_solver_596.py` |
...
4. 最小范围交付：静态候选 **22** 个文件（§一），其中「真正 import 沙箱/变异工具或 subprocess 驱动它们」的窄集为 `test_622_a1/a2`、`test_622_a4`、`test_cross_card_attack_624`、`test_high_complexity_mutator_623`、`test_high_complexity_sandbox_run_623`、`test_bridge_edge_proposal_613`、`test_mutation_shape_588` —— 逐组实跑**均未复现**。
