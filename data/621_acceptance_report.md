...
> 批次：621 · 起始 `d5edb14`（620 收工）· 收工 HEAD `cf5c1e1`
> **本批 16 commit**（`d5edb14..cf5c1e1` 区间共 17 条，另含 1 条并行 PM 会话插入的 commit，见 §七.7）
...
| 本批 commit 数 | 17 任务 | **16 本批**（+1 并行 PM commit = 区间 17） | 见 §七.7 |
