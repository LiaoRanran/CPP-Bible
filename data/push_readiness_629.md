...
| 629 | 15（本批，持续增加） | 自身免疫率 × 验证器攻击面 × 他验深化 × 闭环第八轮 | run_629_gate 待 F1 |

远程 HEAD：`793b5c45`（624）；本地 HEAD：`64c7709b`（629 D3 后）。
...
1. **方案 A（推荐）：一次性 push 全部 77 commit**，随 push 附一句说明「pytest 19 项红为
   626-628 遗留状态快照断言，非 629 引入，清单见 629 基线台账」。理由：628/629 的地基是
