...
| 3 生成 VSA 凭证 | B2（HMAC-SHA256） | `data\vsa\attestation_20260923T041647Z.json` |
| 4 追加透明日志 | B3（append-only） | index=14（entry_hash 76a77b246e388020…） |
| 5 日志完整性 | B3（线性哈希链） | 完整（15 条） |
| 6 凭证存在性 | B3（inclusion） | 在册 index=14 |
...
> 在 2026-09-23T04:16:48Z，独立验证者 independent_verifier_628（脚本 sha256 a85cad4faa914506…）对输入 ledger=452 条 / PCK=83 张 / 节点 grounded_labels 独立重算得 W2 IN/OUT/UNDEC=114/7/0，与系统 V2 投影 IN/OUT/UNDEC=114/7/0 一致；凭证 data\vsa\attestation_20260923T041647Z.json 已存入透明日志 index=14（entry_hash=76a77b246e388020…），日志链完整（15 条）。
