...
.Ltext0:
	...
	.file 0 "C:/CodeLearnling/note/note/C++/CPP-Bible" "Examples/_ch147_format.cpp"
	.section .rdata,"dr"
.LC0:
	.ascii "%s\12\0"
	.text
...
main:
.LFB21:
	.file 1 "Examples/_ch147_format.cpp"
	.loc 1 2 11
	.cfi_startproc
	push	rbp
	.seh_pushreg	rbp
	...
	mov	edx, eax
	call	__mingw_printf
	.loc 1 2 48 discriminator 1
	mov	eax, 0
	.loc 1 2 48 is_stmt 0
	add	rsp, 48
	pop	rbp
	.cfi_restore 6
	.cfi_def_cfa 7, 8
...
.LASF0:
	.ascii "Examples\\_ch147_format.cpp\0"
