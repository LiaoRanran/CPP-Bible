...
.Ltext0:
	...
	.file 0 "C:/CodeLearnling/note/note/C++/CPP-Bible" "Examples/_ch147_leak.cpp"
	.globl	_Z4makev
	.def	_Z4makev;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z4makev
_Z4makev:
.LFB21:
	.file 1 "Examples/_ch147_leak.cpp"
	.loc 1 2 13
	.cfi_startproc
	push	rbp
	.seh_pushreg	rbp
	...
	call	_Znwy
	mov	rbx, rax
	.loc 1 2 31 is_stmt 0 discriminator 1
	mov	DWORD PTR [rbx], 1
	mov	eax, 0
	.loc 1 2 31 discriminator 2
	test	al, al
	je	.L3
	.loc 1 2 31 discriminator 3
	mov	edx, 4
	mov	rcx, rbx
	call	_ZdlPvy
.L3:
	.loc 1 2 31 discriminator 7
	mov	rax, rbx
	.loc 1 2 34 is_stmt 1
	add	rsp, 40
	pop	rbx
	.cfi_restore 3
	pop	rbp
...
.LFB22:
	...
	.loc 1 3 26
	call	_Z4makev
	.loc 1 3 26 is_stmt 0 discriminator 1
	mov	QWORD PTR -8[rbp], rax
	.loc 1 3 41 is_stmt 1 discriminator 1
	mov	rax, QWORD PTR -8[rbp]
	mov	eax, DWORD PTR [rax]
	lea	rcx, .LC0[rip]
	mov	edx, eax
	call	__mingw_printf
	.loc 1 3 72 discriminator 2
	mov	eax, 0
	.loc 1 3 72 is_stmt 0
	add	rsp, 48
	pop	rbp
	.cfi_restore 6
	.cfi_def_cfa 7, 8
...
.LASF0:
	.ascii "Examples\\_ch147_leak.cpp\0"
