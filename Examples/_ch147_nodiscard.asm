...
.Ltext0:
	...
	.file 0 "C:/CodeLearnling/note/note/C++/CPP-Bible" "Examples/_ch147_nodiscard.cpp"
	.globl	_Z9importantv
	.def	_Z9importantv;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z9importantv
_Z9importantv:
.LFB21:
	.file 1 "Examples/_ch147_nodiscard.cpp"
	.loc 1 2 31
	.cfi_startproc
	push	rbp
	.seh_pushreg	rbp
...
.LFB22:
	...
	.loc 1 3 22
	call	_Z9importantv
	.loc 1 3 37 discriminator 1
	lea	rax, .LC0[rip]
	mov	rcx, rax
	call	__mingw_printf
	.loc 1 3 52 discriminator 2
	mov	eax, 0
	.loc 1 3 52 is_stmt 0
	add	rsp, 32
	pop	rbp
	.cfi_restore 6
	.cfi_def_cfa 7, 8
...
.LASF0:
	.ascii "Examples\\_ch147_nodiscard.cpp\0"
