...
| 剩余待办？ | **内容侧**：优先审 8 个 UNVERIFIED 章（ch02/05/16/132/148/149/150/165），见下文健康度评估；ch163 网络章是否补 POSIX 对照（低优先）。**工具链**：剩余项见 `TOOLCHAIN_UPGRADE_NEXT.md`（mypy 类型 triage 等）。**看板**：15 条标准 10/15，剩余 5 项均属诚实边界，见 `HANDOVER.md` |
