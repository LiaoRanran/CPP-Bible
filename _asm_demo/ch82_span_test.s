...
/tmp/ch82_span.exe:     file format pei-x86-64
...
0000000140001760 <sum_span(std::span<int const, 18446744073709551615ull>)>:
   140001760:	48 8b 51 08          	mov    rdx,QWORD PTR [rcx+0x8]
   140001764:	48 8b 01             	mov    rax,QWORD PTR [rcx]
   140001767:	48 8d 0c 90          	lea    rcx,[rax+rdx*4]
   14000176b:	31 d2                	xor    edx,edx
   14000176d:	48 39 c8             	cmp    rax,rcx
   140001770:	74 19                	je     14000178b <sum_span(std::span<int const, 18446744073709551615ull>)+0x2b>
   140001772:	0f 1f 00             	nop    DWORD PTR [rax]
   140001775:	66 66 2e 0f 1f 84 00 	data16 cs nop WORD PTR [rax+rax*1+0x0]
   14000177c:	00 00 00 00 
   140001780:	03 10                	add    edx,DWORD PTR [rax]
   140001782:	48 83 c0 04          	add    rax,0x4
   140001786:	48 39 c8             	cmp    rax,rcx
   140001789:	75 f5                	jne    140001780 <sum_span(std::span<int const, 18446744073709551615ull>)+0x20>
   14000178b:	89 d0                	mov    eax,edx
   14000178d:	c3                   	ret
   14000178e:	66 90                	xchg   ax,ax

0000000140001790 <sum_ptr(int const*, unsigned long long)>:
   140001790:	48 85 d2             	test   rdx,rdx
   140001793:	74 1b                	je     1400017b0 <sum_ptr(int const*, unsigned long long)+0x20>
   140001795:	48 8d 14 91          	lea    rdx,[rcx+rdx*4]
   140001799:	31 c0                	xor    eax,eax
   14000179b:	0f 1f 44 00 00       	nop    DWORD PTR [rax+rax*1+0x0]
   1400017a0:	03 01                	add    eax,DWORD PTR [rcx]
   1400017a2:	48 83 c1 04          	add    rcx,0x4
   1400017a6:	48 39 d1             	cmp    rcx,rdx
   1400017a9:	75 f5                	jne    1400017a0 <sum_ptr(int const*, unsigned long long)+0x10>
   1400017ab:	c3                   	ret
   1400017ac:	0f 1f 40 00          	nop    DWORD PTR [rax+0x0]
   1400017b0:	31 c0                	xor    eax,eax
   1400017b2:	c3                   	ret
   1400017b3:	66 90                	xchg   ax,ax
   1400017b5:	66 66 2e 0f 1f 84 00 	data16 cs nop WORD PTR [rax+rax*1+0x0]
   1400017bc:	00 00 00 00 

00000001400017c0 <at_span(std::span<int const, 18446744073709551615ull>, unsigned long long)>:
   1400017c0:	48 8b 01             	mov    rax,QWORD PTR [rcx]
   1400017c3:	48 8d 14 90          	lea    rdx,[rax+rdx*4]
   1400017c7:	8b 02                	mov    eax,DWORD PTR [rdx]
   1400017c9:	c3                   	ret
   1400017ca:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]

00000001400017d0 <emit_size()>:
   1400017d0:	c7 05 a6 78 00 00 10 	mov    DWORD PTR [rip+0x78a6],0x10        # 140009080 <g_obs>
   1400017d7:	00 00 00 
   1400017da:	c3                   	ret
   1400017db:	90                   	nop
   1400017dc:	90                   	nop
...
0000000140003330 <main>:
   ...
   140003339:	b8 0a 00 00 00       	mov    eax,0xa
   14000333e:	c7 05 38 5d 00 00 10 	mov    DWORD PTR [rip+0x5d38],0x10        # 140009080 <g_obs>
   140003345:	00 00 00 
   140003348:	48 83 c4 28          	add    rsp,0x28
   14000334c:	c3                   	ret
   14000334d:	90                   	nop
   14000334e:	90                   	nop
   14000334f:	90                   	nop
