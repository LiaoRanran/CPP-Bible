...
ch79_list_test.exe:     file format pei-x86-64
...
0000000140001778 <std::__detail::_List_node_base::_M_hook(std::__detail::_List_node_base*)>:
   140001778:	ff 25 7a 8a 00 00    	jmp    QWORD PTR [rip+0x8a7a]        # 14000a1f8 <__imp__ZNSt8__detail15_List_node_base7_M_hookEPS0_>
   14000177e:	90                   	nop
   14000177f:	90                   	nop
...
00000001400032e0 <main.cold>:
   1400032e0:	48 8b 4c 24 30       	mov    rcx,QWORD PTR [rsp+0x30]
   1400032e5:	48 39 f1             	cmp    rcx,rsi
   1400032e8:	74 12                	je     1400032fc <main.cold+0x1c>
   1400032ea:	48 8b 19             	mov    rbx,QWORD PTR [rcx]
   1400032ed:	ba 18 00 00 00       	mov    edx,0x18
   1400032f2:	e8 79 e4 ff ff       	call   140001770 <operator delete(void*, unsigned long long)>
   1400032f7:	48 89 d9             	mov    rcx,rbx
   1400032fa:	eb e9                	jmp    1400032e5 <main.cold+0x5>
   1400032fc:	48 89 f9             	mov    rcx,rdi
   1400032ff:	e8 4c fd ff ff       	call   140003050 <_Unwind_Resume>
   140003304:	90                   	nop
   140003305:	90                   	nop
   140003306:	90                   	nop
   140003307:	90                   	nop
...
0000000140003310 <main>:
   ...
   140003313:	48 83 ec 50          	sub    rsp,0x50
   140003317:	31 db                	xor    ebx,ebx
   140003319:	e8 19 e5 ff ff       	call   140001837 <__main>
   14000331e:	48 8d 74 24 30       	lea    rsi,[rsp+0x30]
   140003323:	48 c7 44 24 40 00 00 	mov    QWORD PTR [rsp+0x40],0x0
   14000332a:	00 00 
   14000332c:	66 48 0f 6e c6       	movq   xmm0,rsi
   140003331:	66 0f 6c c0          	punpcklqdq xmm0,xmm0
   140003335:	0f 29 44 24 30       	movaps XMMWORD PTR [rsp+0x30],xmm0
   14000333a:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]
   140003340:	b9 18 00 00 00       	mov    ecx,0x18
   140003345:	e8 1e e4 ff ff       	call   140001768 <operator new(unsigned long long)>
   14000334a:	89 58 10             	mov    DWORD PTR [rax+0x10],ebx
   14000334d:	48 89 f2             	mov    rdx,rsi
   140003350:	48 89 c1             	mov    rcx,rax
   140003353:	83 c3 01             	add    ebx,0x1
   140003356:	e8 1d e4 ff ff       	call   140001778 <std::__detail::_List_node_base::_M_hook(std::__detail::_List_node_base*)>
   14000335b:	48 83 44 24 40 01    	add    QWORD PTR [rsp+0x40],0x1
   140003361:	83 fb 64             	cmp    ebx,0x64
   140003364:	75 da                	jne    140003340 <main+0x30>
   140003366:	48 8b 5c 24 30       	mov    rbx,QWORD PTR [rsp+0x30]
   14000336b:	48 39 f3             	cmp    rbx,rsi
   14000336e:	74 4f                	je     1400033bf <main+0xaf>
   140003370:	48 89 d8             	mov    rax,rbx
   140003373:	31 d2                	xor    edx,edx
   140003375:	66 66 2e 0f 1f 84 00 	data16 cs nop WORD PTR [rax+rax*1+0x0]
   14000337c:	00 00 00 00 
   140003380:	03 50 10             	add    edx,DWORD PTR [rax+0x10]
   140003383:	48 8b 00             	mov    rax,QWORD PTR [rax]
   140003386:	48 39 f0             	cmp    rax,rsi
   140003389:	75 f5                	jne    140003380 <main+0x70>
   14000338b:	89 54 24 2c          	mov    DWORD PTR [rsp+0x2c],edx
   14000338f:	8b 44 24 2c          	mov    eax,DWORD PTR [rsp+0x2c]
   140003393:	66 90                	xchg   ax,ax
   140003395:	66 66 2e 0f 1f 84 00 	data16 cs nop WORD PTR [rax+rax*1+0x0]
   14000339c:	00 00 00 00 
   1400033a0:	48 89 d9             	mov    rcx,rbx
   1400033a3:	48 8b 1b             	mov    rbx,QWORD PTR [rbx]
   1400033a6:	ba 18 00 00 00       	mov    edx,0x18
   1400033ab:	e8 c0 e3 ff ff       	call   140001770 <operator delete(void*, unsigned long long)>
   1400033b0:	48 39 f3             	cmp    rbx,rsi
   1400033b3:	75 eb                	jne    1400033a0 <main+0x90>
   1400033b5:	31 c0                	xor    eax,eax
   1400033b7:	48 83 c4 50          	add    rsp,0x50
   1400033bb:	5b                   	pop    rbx
   1400033bc:	5e                   	pop    rsi
   1400033bd:	5f                   	pop    rdi
   1400033be:	c3                   	ret
   1400033bf:	31 c0                	xor    eax,eax
   1400033c1:	89 44 24 2c          	mov    DWORD PTR [rsp+0x2c],eax
   1400033c5:	8b 44 24 2c          	mov    eax,DWORD PTR [rsp+0x2c]
   1400033c9:	eb ea                	jmp    1400033b5 <main+0xa5>
   1400033cb:	48 89 c7             	mov    rdi,rax
   1400033ce:	e9 0d ff ff ff       	jmp    1400032e0 <main.cold>
   1400033d3:	90                   	nop
   1400033d4:	90                   	nop
   1400033d5:	90                   	nop
   1400033d6:	90                   	nop
...
00000001400033e0 <register_frame_ctor>:
   1400033e0:	e9 8b e2 ff ff       	jmp    140001670 <__gcc_register_frame>
   1400033e5:	90                   	nop
   1400033e6:	90                   	nop
   1400033e7:	90                   	nop
   1400033e8:	90                   	nop
