...
> 标准基: C++23 / GCC 13.1 / 预计阅读: 70min / [第152章　性能模型与测量学](Book/part14_perf/ch152_perf_model.md) [第154章　缓存优化与数据局部性（C++/硬件）](Book/part14_perf/ch154_cache_opt.md) / 难度: ★★★★☆｜层级：L3 专家
...
- **跨模块延伸**：[第159章 从零实现线程池（C++）](Book/part15_cases/ch159_threadpool.md)）
- **跨模块延伸**：[第160章 从零实现内存池（C++）](Book/part15_cases/ch160_mempool.md)）
