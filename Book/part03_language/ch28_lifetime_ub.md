...
<svg viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="图：栈对象 vs 堆对象构造/析构开销">
  <text x="340" y="26" text-anchor="middle" font-size="14.5" font-family="Georgia, 'Times New Roman', serif" font-weight="bold">图：栈对象 vs 堆对象构造/析构开销</text>
  ...
  <text x="20" y="176" text-anchor="middle" font-size="12" font-family="Georgia, serif" transform="rotate(-90 20 176)">相对倍数 (×, 栈 RAII=1.00)</text>
  <line x1="80" y1="250.4" x2="640" y2="250.4" stroke="#C44E52" stroke-width="1.2" stroke-dasharray="5 4"/>
  <text x="640" y="246.4" text-anchor="end" font-size="10.5" font-family="Georgia, serif" fill="#C44E52">1.00× 基线 (栈 RAII)</text>
  ...
  <text x="173.3" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 173.3 314.0)">栈 RAII auto</text>
  <rect x="328.0" y="146.2" width="64.0" height="153.8" fill="#DD8452"/>
  <text x="360.0" y="140.2" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#DD8452">3.10×</text>
  ...
  <rect x="514.7" y="151.2" width="64.0" height="148.8" fill="#55A868"/>
  <text x="546.7" y="145.2" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#55A868">3.00×</text>
