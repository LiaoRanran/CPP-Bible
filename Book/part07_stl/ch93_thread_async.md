...
<svg viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="(a) 绝对耗时（随机器而变，仅作量级参考）">
  ...
  <text x="640" y="55.3" text-anchor="end" font-size="10.5" font-family="Georgia, serif" fill="#C44E52">基线 814.93ms</text>
  <rect x="141.3" y="59.3" width="64.0" height="240.7" fill="#9A9A9A"/>
  <text x="173.3" y="53.3" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#9A9A9A">815ms</text>
  <text x="173.3" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 173.3 314.0)">std::async(launch::async) 每次调用都建线程</text>
  <rect x="328.0" y="288.7" width="64.0" height="11.3" fill="#DD8452"/>
  <text x="360.0" y="282.7" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#DD8452">1.37ms</text>
  <text x="360.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 360.0 314.0)">预建线程池（单 worker 复用，K=16）</text>
  <rect x="514.7" y="246.0" width="64.0" height="54.0" fill="#C44E52"/>
  <text x="546.7" y="240.0" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#C44E52">4.50ms</text>
  <text x="546.7" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 546.7 314.0)">std::async(launch::deferred) 惰性同步执行</text>
</svg>
...
<svg viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="(b) 相对倍数（可移植信号：基准=1.00×）">
  ...
  <text x="173.3" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 173.3 314.0)">std::async(launch::async) 每次调用都建线程</text>
  <rect x="328.0" y="299.6" width="64.0" height="0.4" fill="#DD8452"/>
  <text x="360.0" y="293.6" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#DD8452">0.00×</text>
  <text x="360.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 360.0 314.0)">预建线程池（单 worker 复用，K=16）</text>
  <rect x="514.7" y="298.6" width="64.0" height="1.4" fill="#C44E52"/>
  <text x="546.7" y="292.6" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#C44E52">0.01×</text>
  <text x="546.7" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 546.7 314.0)">std::async(launch::deferred) 惰性同步执行</text>
</svg>
