...
> **示例 1** <span class="badge badge-exp">难度 ★★☆☆☆</span> · 的性能陷阱
```cpp
#include <iostream>
#include <cstdio>
int main() {
...
> **示例 2** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · <bool> 的容器陷阱
```cpp
#include <vector>
#include <iostream>
int main() {
...
<span class="badge badge-std">标准</span> C++98/03已过时，新项目至少用C++17。
<span class="badge badge-exp">经验</span> 理解C++98的"技术债"有助于理解为什么现代C++走了某些设计路径。
...
> **示例 4** <span class="badge badge-exp">难度 ★★★★☆</span> · 性能证据
```cpp
#include <iostream>
#include <format>
#include <chrono>
...
> **示例 6** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · C++98的工业遗产
```cpp
#include <iostream>
...
> **示例 7** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · 的性能陷阱
```cpp
#include <iostream>
...
> **示例 8** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · 附录 I：C++98到C++20的3
```cpp
#include <iostream>
...
> **示例 9** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · 附录 J：C++98面试高频
```cpp
#include <iostream>
...
> **示例 11** <span class="badge badge-exp">难度 ★★★☆☆</span> · 首个完整C++98实现
```cpp
#include <iostream>
// GCC 2.95的C++98实现关键点:
...
> **示例 12** <span class="badge badge-exp">难度 ★★★☆☆</span> · 平台的C++98
```cpp
#include <iostream>
int main() {
...
> **示例 13** <span class="badge badge-exp">难度 ★★☆☆☆</span> · C++98 / C++03：奠基时代
```cpp
#include <iostream>
#include <variant>
int main() {
...
> **示例 14** <span class="badge badge-exp">难度 ★★★☆☆</span> · 附录 N：C++98→C++11的1
```
1998: C++98发布
...
> **示例 15** <span class="badge badge-exp">难度 ★☆☆☆☆</span> · 附录 N：C++98→C++11的1
```cpp
#include <iostream>
int main() {
...
<span class="badge badge-std">标准</span> C++98是C++的奠基标准, STL至今仍是标准库核心。
<span class="badge badge-exp">经验</span> 理解C++98的技术债(auto_ptr/vector<bool>/COW)有助于理解现代C++的设计动机。
...
> **示例 21** <span class="badge badge-exp">难度 ★★★☆☆</span> · 练习 4（难度 ★★）
```cpp
#include <cstdio>
...
> **示例  22** <span class="badge badge-exp">难度 ★★★☆☆</span> · 练习 5（难度 ★★★）
```cpp
#include <cstdio>
...
> **示例 19** <span class="badge badge-exp">难度 ★★☆☆☆</span> · 演绎 1：RAII —— C++98
```cpp
#include <iostream>
#include <cstdio>
...
> **示例 20** <span class="badge badge-exp">难度 ★★☆☆☆</span> · 演绎 2：函数对象（functor）
```cpp
#include <iostream>
#include <vector>
#include <algorithm>
