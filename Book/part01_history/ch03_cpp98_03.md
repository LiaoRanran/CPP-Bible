...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 150" font-family="'Microsoft YaHei','PingFang SC','Noto Sans CJK SC',sans-serif" font-size="13">
  ...
  <text x="124" y="46" font-size="13" font-weight="bold" fill="#1a1a1a">Bjarne Stroustrup，《The C++ P</text>
  <text x="124" y="70" font-size="13" font-weight="bold" fill="#1a1a1a">rogramming Language》与《Annota</text>
  <text x="124" y="94" font-size="13" font-weight="bold" fill="#1a1a1a">ted C++ Reference Manual》(AR…</text>
