...
!!! note "类比：WG21 = 语言联合国"
    WG21 委员会可以**类比**为「语言界的联合国安理会」——任何重大特性（提案）都要经小组审查 + 全员投票才能进标准；它比「独裁式」设计慢，却换来广泛共识与可追溯历史。提案—评审—投票流程更**好比**学术论文的同行评议——公开、可被挑战、留下记录，而非某个人拍板。
    换个角度：国家体一票能左右特性去留也**类似于**安理会的否决权——法国曾对 C++20 Modules 投反对票让发布推迟约三个月，是「共识」有时等于「最低共同点」而非最优解。

    > 失效边界：委员会「保守慢热」的代价真实存在——concepts 耗时约 15 年才落地，常被嫌动作迟缓；投票权按国家分配，「广泛共识」不代表「技术最优」，慢决策本身也是不靠一人拍板的代价。

> **一句话结论**：C++ 把自己交给公开委员会 WG21：用「提案—评审—投票」换广泛共识与可追溯历史，代价是决策慢、常被嫌保守。
...
- `[isocpp:<wg21>]`（T2）isocpp 官方 FAQ —— 在线 `https://isocpp.org/faq`
