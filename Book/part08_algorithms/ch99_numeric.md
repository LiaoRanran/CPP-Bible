...
- `[平台·x86-64]`：并行后端是**实现质量**而非标准强制——标准只规定 `execution::par` 的语义（允许并行），不规定"必须有 N 个线程"。因此性能可移植性 ≠ 语义可移植性。
...
<svg viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="(a) 绝对耗时（随机器而变，仅作量级参考）">
  ...
  <line x1="80" y1="78.8" x2="640" y2="78.8" stroke="#C44E52" stroke-width="1.2" stroke-dasharray="5 4"/>
  <text x="640" y="74.8" text-anchor="end" font-size="10.5" font-family="Georgia, serif" fill="#C44E52">基线 89.21ms</text>
  <rect x="118.0" y="78.8" width="64.0" height="221.2" fill="#9A9A9A"/>
  <text x="150.0" y="72.8" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#9A9A9A">89.21ms</text>
  <text x="150.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 150.0 314.0)">accumulate float ×5</text>
  <rect x="258.0" y="162.0" width="64.0" height="138.0" fill="#C44E52"/>
  <text x="290.0" y="156.0" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#C44E52">55.65ms</text>
  <text x="290.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 290.0 314.0)">reduce float ×5</text>
  <rect x="398.0" y="194.7" width="64.0" height="105.3" fill="#55A868"/>
  <text x="430.0" y="188.7" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#55A868">42.47ms</text>
  <text x="430.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 430.0 314.0)">accumulate int ×5</text>
  <rect x="538.0" y="191.4" width="64.0" height="108.6" fill="#8172B3"/>
  <text x="570.0" y="185.4" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#8172B3">43.80ms</text>
  <text x="570.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 570.0 314.0)">reduce int ×5</text>
</svg>
...
<svg viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="(b) 相对倍数（可移植信号：基准=1.00×）">
  ...
  <text x="150.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 150.0 314.0)">accumulate float ×5</text>
  <rect x="258.0" y="145.3" width="64.0" height="154.7" fill="#C44E52"/>
  <text x="290.0" y="139.3" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#C44E52">0.62×</text>
  <text x="290.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 290.0 314.0)">reduce float ×5</text>
  <rect x="398.0" y="181.9" width="64.0" height="118.1" fill="#55A868"/>
  <text x="430.0" y="175.9" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#55A868">0.48×</text>
  <text x="430.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 430.0 314.0)">accumulate int ×5</text>
  <rect x="538.0" y="178.2" width="64.0" height="121.8" fill="#8172B3"/>
  <text x="570.0" y="172.2" text-anchor="middle" font-size="11" font-weight="bold" font-family="Georgia, serif" fill="#8172B3">0.49×</text>
  <text x="570.0" y="314.0" text-anchor="end" font-size="10.5" font-family="Georgia, serif" transform="rotate(-32 570.0 314.0)">reduce int ×5</text>
</svg>
...
- `[cppref:cpp/algorithm/reduce]`（T1）cppreference `cpp/algorithm/reduce` —— 离线 `C:\Users\ASUS\Desktop\cppb参考资料\cppreference\`
