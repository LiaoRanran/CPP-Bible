...
- 引用 (ch20) ⇄ 生命周期 (ch28) ⇄ 悬垂 (ch28 UB)
- const (ch21) ⇄ constexpr (ch69) ⇄ 编译期 (ch123)
- 虚函数 (ch47) ⇄ 对象布局 (ch45) ⇄ 多继承 (ch50) ⇄ 虚继承 (ch49)
