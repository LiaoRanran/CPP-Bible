...
matrix:
  ...
  opt: [-O2]
  arch: [x86-64]
fixture: Examples/_atom_sso_size.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/_atom_sso_size.cpp -o Examples/_atom_sso_size.asm
  g++ -std=c++23 -O2 Examples/_atom_sso_size.cpp -o build/_replay_sso_size.exe && ./build/_replay_sso_size.exe
artifact: Examples/_atom_sso_size.asm
