...
matrix:
  ...
  opt: [-O2]
  arch: [x86-64]
fixture: Examples/atoms/_atom_value_cat.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/atoms/_atom_value_cat.cpp -o Examples/atoms/_atom_value_cat.asm
  g++ -std=c++23 -O2 Examples/atoms/_atom_value_cat.cpp -o build/_replay_vc.exe && ./build/_replay_vc.exe
artifact: Examples/atoms/_atom_value_cat.asm
