...
matrix:
  ...
  opt: [-O2]
  arch: [x86-64]
fixture: Examples/_atom_rule_zero.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/_atom_rule_zero.cpp -o Examples/_atom_rule_zero.asm
  g++ -std=c++23 -O2 Examples/_atom_rule_zero.cpp -o build/_replay_rz.exe && ./build/_replay_rz.exe
artifact: Examples/_atom_rule_zero.asm
