...
matrix:
  ...
  opt: [-O0, -O2]
  arch: [x86-64]
fixture: Examples/_atom_alloc_pmr.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/_atom_alloc_pmr.cpp -o Examples/_atom_alloc_pmr.asm
  g++ -std=c++23 -O2 Examples/_atom_alloc_pmr.cpp -o build/_replay_alloc_pmr.exe && ./build/_replay_alloc_pmr.exe
artifact: Examples/_atom_alloc_pmr.asm
