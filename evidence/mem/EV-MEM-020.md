...
matrix:
  ...
  opt: [-O2]
  arch: [x86-64]
fixture: Examples/_atom_align_ctrl.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/_atom_align_ctrl.cpp -o Examples/_atom_align_ctrl.asm
  g++ -std=c++23 -O2 Examples/_atom_align_ctrl.cpp -o build/_replay_actl.exe && ./build/_replay_actl.exe
artifact: Examples/_atom_align_ctrl.asm
