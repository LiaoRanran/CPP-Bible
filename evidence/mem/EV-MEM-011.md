...
matrix:
  ...
  opt: [-O2]
  arch: [x86-64]
fixture: Examples/atoms/_atom_unique_size.cpp
command: |
  g++ -std=c++23 -O2 -S -masm=intel Examples/atoms/_atom_unique_size.cpp -o Examples/atoms/_atom_unique_size.asm
  g++ -std=c++23 -O2 Examples/atoms/_atom_unique_size.cpp -o build/_replay_usz.exe && ./build/_replay_usz.exe
artifact: Examples/atoms/_atom_unique_size.asm
