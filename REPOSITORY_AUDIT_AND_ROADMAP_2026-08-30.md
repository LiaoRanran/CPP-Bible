...
| 优先级 | 风险 | 影响 | 建议控制 |
|---|---|---|---|
| P0 | 备份与源同机同盘 | 单点故障可同时丢失源和备份 | ✅ 已缓解：异盘副本落 `D:\CPP-Bible-Backup\20260830-201021`（明文，恢复演练 PASS） |
...
| 优先级 | 任务 | 资源 | 预期成果/验收 |
|---|---|---|---|
| P0 | 将备份复制到加密外置盘或对象存储 | 维护者 0.5 人日；约 100 MiB 空间 | ✅ 已完成 2026-08-30：异盘副本 `D:\CPP-Bible-Backup\20260830-201021`（bundle 14.3MB + tar.zst 43.8MB），SHA-256 一致，恢复 `git fsck` 通过（明文副本，7z 加密为可选加固） |
